//==========================================================================
//
//      devs_eth_arm_mini2440.inl
//
//      FriendlyARM MINI2440's DM9000 ethernet I/O definitions.
//
//==========================================================================
...
#include <cyg/hal/hal_io.h>		// HAL_READ / HAL_WRITE
...
static struct dm9000	dm9000_eth0_priv_data = {
	...
	io_data: (volatile unsigned char *) 0x20000004
};
...
RedBoot_config_option(
	...
	true,
	CONFIG_ESA,
	dm9000_eth0_priv_data.mac_address
);
#endif
...
CYG_MACRO_START \
	ok = false; \
	if (0 == p_dm9000->index) \
		ok = CYGACC_CALL_IF_FLASH_CFG_OP(CYGNUM_CALL_IF_FLASH_CFG_GET, "eth0_esa", mac_address, CONFIG_ESA); \
	else if (1 == p_dm9000->index) \
		ok = CYGACC_CALL_IF_FLASH_CFG_OP(CYGNUM_CALL_IF_FLASH_CFG_GET, "eth1_esa", mac_address, CONFIG_ESA); \
CYG_MACRO_END

#endif // CYGPKG_DEVS_ETH_DM9000_ETH_REDBOOT_HOLDS_ESA

// ---------------------------------------------------------------------------
// EOF devs_eth_arm_mini2440.inl
