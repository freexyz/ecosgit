#ifndef CYGONCE_HAL_ARM_ARM9_MINI2440_MINI2440_H
#define CYGONCE_HAL_ARM_ARM9_MINI2440_MINI2440_H
//=============================================================================
//
//      mini2440.h
//
//      FriendlyARM MINI2440 specific memory configuration
//
//=============================================================================
...
// Date:		2009-12-24
// Purpose:		FriendlyARM MINI2440 platform specific memory configuration
// Description:
// Usage:		#include <cyg/hal/mini2440.h>
...
#define B1_BWSCON		(DW16)		// N.C.
#define B2_BWSCON		(DW16)		// N.C.
#define B3_BWSCON		(DW16+WAIT+UBLB)// N.C.
#define B4_BWSCON		(DW16+WAIT+UBLB)// Ethernet(DM9000), 16-bit
#define B5_BWSCON		(DW8)		// N.C.
#define B6_BWSCON		(DW32)		// SDRAM(HY57V561620) 32MBx2, 32-bit
#define B7_BWSCON		(DW32)		// N.C.
...
#endif // CYGONCE_HAL_ARM_ARM9_MINI2440_MINI2440_H
//-----------------------------------------------------------------------------
// end of mini2440.h
