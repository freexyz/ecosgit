...
// Description:		The interrupt details for the Samsung S3C2440x are defined here.
// Usage:
...
// These are interrupts on the S3C2440x
...
#define CYGNUM_HAL_INTERRUPT_CAM	6
#define CYGNUM_HAL_INTERRUPT_BAT_FLT	7
#define CYGNUM_HAL_INTERRUPT_TICK	8
#define CYGNUM_HAL_INTERRUPT_WDT_AC97	9
...
#define CYGNUM_HAL_INTERRUPT_NFCON	24
