#ifndef CYGONCE_HAL_ARM_ARM9_S3C2440X_H
#define CYGONCE_HAL_ARM_ARM9_S3C2440X_H
...
// Date:		2009-12-22
// Purpose:		Samsung S3C2440x platform specific support definitions
// Description:
// Usage:		#include <cyg/hal/hal_s3c2440x.h>
//
//####DESCRIPTIONEND####
//
//=============================================================================

#include <pkgconf/hal_arm_arm9_s3c2440x.h>

// Internal clocks
#define FCLK			CYGNUM_HAL_ARM_S3C2440X_CPU_CLOCK
#define HCLK			CYGNUM_HAL_ARM_S3C2440X_AHB_CLOCK
#define PCLK			CYGNUM_HAL_ARM_S3C2440X_APB_CLOCK
...
#endif // CYGONCE_HAL_ARM_ARM9_S3C2440X_H
//-----------------------------------------------------------------------------
// end of hal_s3c2440x.h
